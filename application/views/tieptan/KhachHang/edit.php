        ...
        <div class="col-md-8 col-md-offset-2">
            <form class="form-horizontal panel" method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" value="<?php echo $info->TEN ?>" id="ten" name="ten" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" pattern="(\d){9,10}" class="form-control"  value="<?php echo $info->SODT ?>" id="sodt" name="sodt" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control"  value="<?php echo $info->DIACHI ?>" id="diachi" name="diachi" required>
