            ...
            <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="act-list">
                            <a href="<?php echo tieptan_url('khachhang/edit/'.$row->ID); ?>" data-toggle="tooltip" title="Chỉnh sửa"><i class="fa fa-wrench" aria-hidden="true"></i></a>
<!--                            <a href="<?php echo tieptan_url('khachhang/delete/'.$row->ID); ?>" data-toggle="tooltip" title="Xóa">
