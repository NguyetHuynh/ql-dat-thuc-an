                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav">
                        <li><a href="<?php echo base_url('ketoan/home') ?>">Giao Hàng<span class="sr-only">(current)</span></a></li>
                        <li class="active"><a href="<?php echo base_url('ketoan/home/taiban') ?>">Tại Bàn</a></li>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo base_url('ketoan/home/taibanbill/'.$row->ID) ?>" class="btn btn-danger" role="button">Thanh Toán</a>
                        <?php elseif($row->TINHTRANG == 3)://da thanh toan ?>
                        <a href="<?php echo base_url('ketoan/home/taibanbill/'.$row->ID) ?>" class="btn btn-success" role="button">In Lại Hóa Đơn</a>
                        <?php else: ?>
                    ...
                    <td>
                         <?php
                            ...
                            <?php break; case 2:?>
                            <span style="color:#d9534f"><b>Đã Phục Vụ</b></span>
                            <?php break; case 1:?>
