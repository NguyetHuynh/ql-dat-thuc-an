    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <form class="form-horizontal panel" method="post" action="">
                <legend>Cập nhật hình thức phục vụ</legend>
                <div class="form-group">
                    <label class="control-label col-sm-3" for="ten">Tên hình thức: <span class="required">*</span></label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control"  placeholder="Nhập tên hình thức" 
                             id="ten" name="ten" value="<?php echo $info->TEN ?>" required="required"
                             <?php echo ($info->ID <=2) ? 'readonly' : '' ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control"  placeholder="Nhập phí phục vụ" 
                             id="price" name="phipv" value="<?php echo $info->PHIPV ?>" required>
